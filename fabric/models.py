...
class Fabric(FabricSampleTrackerModel):
    ...
    weave = models.ForeignKey(Weave, on_delete=models.PROTECT, null=True, blank=True)
    appearance = models.ForeignKey(Appearance, on_delete=models.PROTECT, null=True, blank=True)
...
pre_save.connect(populate_time_info, sender=Weave)
pre_save.connect(populate_time_info, sender=Appearance)
